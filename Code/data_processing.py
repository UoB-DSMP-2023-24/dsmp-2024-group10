...
labels_mhcb = torch.load(path + "/Data/mhcb_labels.pt")

dataset = TensorDataset(features, labels_mhcb)
dataloader = DataLoader(dataset=dataset, batch_size=70000, shuffle=True)

# Split train and test data
X_train, X_test, y_train, y_test = train_test_split(features, labels_mhcb, test_size=0.2, random_state=42)
