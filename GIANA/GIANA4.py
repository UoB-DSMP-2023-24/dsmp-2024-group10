...
def EncodeRepertoire(inputfile, outdir, outfile='',exact=True, ST=3.6, thr_v=3.6, thr_s=3.7, VDict={},Vgene=True,thr_iso=10, gap=-6, GPU=False,Mat=False, verbose=False):
    ## No V gene version
...
''')
    ...
    parser.add_option("-M","--EncodingMatrix", dest="Mat", default=True,action="store_true", help="If true, GIANA will export the isometric encoding matrix for each TCR. Default: False.")
